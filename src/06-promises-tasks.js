...
function chainPromises(array, action) {
  const promise = array.reduce((promiseChain, currentPromise) => promiseChain
    .then((chainValues) => currentPromise
      .then((currentValue) => [...chainValues.concat(currentValue)])
      .catch(() => [...chainValues, new Error()])), Promise.resolve([]));
